...
ActiveRecord::Schema[8.0].define(version: 2025_10_06_142905) do
  ...
  create_table "joins_table_publishers_books", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "publishers_books", force: :cascade do |t|
    t.integer "book_id", null: false
    t.integer "publisher_id", null: false
    t.date "published_on"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id"], name: "index_publishers_books_on_book_id"
    t.index ["publisher_id"], name: "index_publishers_books_on_publisher_id"
  end
  ...
  add_foreign_key "publishers_books", "publishers"
